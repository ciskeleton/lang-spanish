...
$lang['imglib_copy_error'] = 'Se ha encontrado un error al intentar reemplazar el archivo. Por favor, asegúrese de que la carpeta es escribible.';
$lang['imglib_copy_failed'] = 'La rutina de copia de imagen ha fallado.';
$lang['imglib_could_not_crop'] = 'No se pudo recortar la imagen.';
$lang['imglib_could_not_resize'] = 'No se pudo redimensionar la imagen.';
$lang['imglib_ext_not_supported'] = 'Las imágenes %s no están soportadas.';
...
$lang['imglib_gif_not_supported'] = 'Las imágenes GIF no suelen estar soportadas habitualmente a causa de restricciones de licencias. Puede que deba usar imágenes JPG o PNG en su lugar.';
$lang['imglib_image_memory_error'] = 'No hay suficiente memoria para procesar esta imagen.';
$lang['imglib_image_process_failed'] = 'Ha fallado el tratamiento de la imagen. Por favor, verifique que el servidor soporta el protocolo elegido y que la ruta a la librería de imagen es correcta.';
...
$lang['imglib_save_failed'] = 'No se ha podido guardar la imagen. Por favor, asegúrese de que la imagen y la carpeta son escribibles.';
$lang['imglib_source_image_required'] = 'Debe especificar una imagen fuente en las preferencias.';
