...
$lang['admin_install_update_confirm'] = '¿Está seguro de que desea actualizar este paquete?';
$lang['admin_install_update_error'] = 'Error al actualizar el paquete.';
$lang['admin_install_update_skip_confirm'] = '¿Está seguro de que desea omitir esta actualización?';
$lang['admin_install_update_skip_error'] = 'No se pudo omitir esta actualización.';
$lang['admin_install_update_skip_success'] = 'Actualización omitida correctamente.';
$lang['admin_install_update_success'] = 'Paquete actualizado correctamente.';
...
$lang['admin_modules_delete_error_active'] = 'Los módulos activos no se pueden eliminar.';
...
$lang['admin_modules_global'] = 'Módulo global (compartido)';
$lang['admin_modules_install_confirm'] = '¿Está seguro de que desea instalar el módulo: <b>%s</b>?';
$lang['admin_modules_install_error'] = 'Error al instalar el módulo.';
$lang['admin_modules_install_success'] = 'Módulo instalado correctamente.';
...
$lang['admin_modules_update_confirm'] = '¿Está seguro de que desea actualizar este módulo?';
$lang['admin_modules_update_error'] = 'Error al actualizar el módulo.';
$lang['admin_modules_update_success'] = 'Módulo actualizado correctamente.';
...
$lang['admin_plugins_delete_error_active'] = 'Los plugins activos no se pueden eliminar.';
...
$lang['admin_plugins_global'] = 'Plugin global (compartido)';
$lang['admin_plugins_install_confirm'] = '¿Está seguro de que desea instalar el plugin: <b>%s</b>?';
$lang['admin_plugins_install_error'] = 'Error al instalar el plugin.';
$lang['admin_plugins_install_success'] = 'Plugin instalado correctamente.';
...
$lang['admin_plugins_update_confirm'] = '¿Está seguro de que desea actualizar este plugin?';
$lang['admin_plugins_update_error'] = 'Error al actualizar el plugin.';
$lang['admin_plugins_update_success'] = 'Plugin actualizado correctamente.';
...
$lang['admin_themes_disable_error_active'] = 'El tema activo no se puede deshabilitar.';
...
$lang['admin_themes_install_confirm'] = '¿Está seguro de que desea instalar el tema: <b>%s</b>?';
$lang['admin_themes_install_error'] = 'Error al instalar el tema.';
$lang['admin_themes_install_success'] = 'Tema instalado correctamente.';
...
$lang['admin_themes_update_confirm'] = '¿Está seguro de que desea actualizar este tema?';
$lang['admin_themes_update_error'] = 'Error al actualizar el tema.';
$lang['admin_themes_update_success'] = 'Tema actualizado correctamente.';
...
$lang['admin_languages_delete_confirm'] = '¿Está seguro de que desea eliminar el idioma: <b>%s</b>?';
$lang['admin_languages_delete_error'] = 'Error al eliminar el idioma.';
$lang['admin_languages_delete_error_active'] = 'Los idiomas activos no se pueden eliminar.';
$lang['admin_languages_delete_error_default'] = 'El idioma predeterminado no se puede eliminar.';
$lang['admin_languages_delete_success'] = 'Idioma eliminado correctamente.';
...
$lang['admin_languages_install_confirm'] = '¿Está seguro de que desea instalar el idioma: <b>%s</b>?';
$lang['admin_languages_install_error'] = 'Error al instalar el idioma.';
$lang['admin_languages_install_success'] = 'Idioma instalado correctamente.';
...
$lang['admin_languages_update_confirm'] = '¿Está seguro de que desea actualizar este idioma?';
$lang['admin_languages_update_error'] = 'Error al actualizar el idioma.';
$lang['admin_languages_update_success'] = 'Idioma actualizado correctamente.';
 ...
 */
$lang['package_already_exists'] = 'El paquete ya existe.';
$lang['package_archive_download_failed'] = 'No se pudo descargar el archivo del paquete.';
$lang['package_backup_create_error'] = 'Error al crear la copia de seguridad del paquete.';
$lang['package_backup_dir_failed'] = 'No se pudo crear el directorio de respaldo %s';
$lang['package_backup_missing'] = 'El archivo de copia de seguridad no existe.';
$lang['package_backup_path_error'] = 'No se pudo resolver la ruta del archivo de copia de seguridad.';
$lang['package_backup_request_invalid'] = 'Solicitud de copia de seguridad no válida.';
$lang['package_backup_restore_error'] = 'Error al restaurar la copia de seguridad del paquete.';
$lang['package_catalog_type_unknown'] = 'Tipo de catálogo desconocido.';
$lang['package_checksum_error'] = 'La verificación de la suma de comprobación (checksum) del paquete falló.';
$lang['package_copy_files_error'] = 'Error al copiar los archivos del paquete al destino.';
$lang['package_copy_updates_error'] = 'Error al copiar los archivos de actualización al destino.';
$lang['package_dest_dir_failed'] = 'No se pudo crear el directorio de destino %s';
$lang['package_destination_error'] = 'No se pudo resolver el destino del paquete.';
$lang['package_download_dir_failed'] = 'No se pudo crear el directorio de descarga %s';
$lang['package_download_empty'] = 'La descarga del paquete devolvió una respuesta vacía.';
$lang['package_download_request_invalid'] = 'Solicitud de descarga de paquete no válida.';
$lang['package_extract_failed'] = 'No se pudo extraer el ZIP %s';
$lang['package_invalid_lang_files'] = 'Idioma no válido: faltan los archivos de idioma requeridos de la aplicación.';
$lang['package_invalid_lang_structure'] = 'Idioma no válido: faltan los directorios admin y/o ci3.';
$lang['package_invalid_missing_info'] = '%s no válido: falta "info.php".';
$lang['package_invalid_module_structure'] = 'Módulo no válido: faltan los directorios config y/o controllers requeridos.';
$lang['package_invalid_plugin_boot'] = 'Plugin no válido: falta "boot.php".';
$lang['package_invalid_plugin_contents'] = 'Plugin no válido: los plugins no pueden contener controladores o vistas.';
$lang['package_invalid_theme_boot'] = 'Tema no válido: falta "boot.php".';
$lang['package_invalid_theme_views'] = 'Tema no válido: falta el directorio views.';
$lang['package_no_root_dir'] = 'El paquete no contiene un directorio raíz.';
$lang['package_not_downloadable'] = 'El paquete no se puede descargar públicamente.';
$lang['package_not_in_registry'] = 'El paquete no está disponible en el registro público.';
$lang['package_request_invalid'] = 'Solicitud de paquete no válida.';
$lang['package_rollback_request_invalid'] = 'Solicitud de reversión (rollback) no válida.';
$lang['package_root_mismatch'] = 'La raíz del archivo del paquete no coincide con %s';
$lang['package_single_root_required'] = 'El paquete debe contener exactamente un directorio raíz.';
$lang['package_source_error'] = 'No se pudo resolver el origen del paquete.';
$lang['package_system_core_restricted'] = 'Los componentes del sistema no se pueden instalar como paquetes.';
$lang['package_temp_dir_failed'] = 'No se pudo crear el directorio temporal %s';
$lang['package_type_unknown'] = 'Tipo de paquete desconocido.';
$lang['package_update_request_invalid'] = 'Solicitud de actualización de paquete no válida.';
$lang['package_update_root_mismatch'] = 'La raíz del archivo de actualización no coincide con %s.';
$lang['package_upload_dir_failed'] = 'No se pudo crear el directorio de subida %s';
$lang['package_url_invalid'] = 'URL de distribución del paquete no válida.';
$lang['package_write_failed'] = 'No se pudo escribir el paquete en %s';
$lang['package_zip_not_found'] = 'El archivo ZIP del paquete no existe: %s';
...
$lang['update_rollback_confirm'] = '¿Está seguro de que desea restaurar la versión anterior?';
